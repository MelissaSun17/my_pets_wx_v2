	...
	.demo-box1 {
		...
		.box-one {
			...
			.box-one-img {
				...
				height: 230rpx;
				background: #FFD1DB;
				border-radius: 120rpx 120rpx 60rpx 60rpx;
				margin: 54rpx 16rpx 44rpx 12rpx;
				...
				.box-one-info {
					...
					box-shadow: 3rpx 3rpx 13rpx rgba(0, 0, 0, 1);
	...
	.demo-box3 {
		...
		.feimi-serve {
			...
			.feimi-serve-text {
				...
				.feimi-serve-text-title {
					width: 176rpx;
					height: 64rpx;
					font-family: HanYiYaKuHei-75W;
					font-weight: normal;
					font-size: 44rpx;
					color: #000000;
					line-height: 64rpx;
			...
			.feimi-serve-icon .icon-view:nth-child(2) {
				margin-left: 52rpx;
				margin-right: 54rpx;
			}

			.feimi-serve-icon .icon-view:nth-child(3) {
				margin-right: 52rpx;
			}
		}
		...
		.pet-trainer {
			...
			.pet-trainer-top {
				...
				.pet-trainer-top-text {
					width: 154rpx;
					height: 64rpx;
					display: flex;
					position: relative;

					.pet-trainer-text-left {
						width: 132rpx;
						height: 64rpx;
			...
			.pet-trainer-intro {
				...
				.pet-trainer-intro-list {
					...
					.pet-trainer-intro-list-img-info {
						margin-left: 24rpx;
						margin-top: 26rpx;
						width: 448rpx;
						height: 140rpx;
